...
type SlotStatus = 'AVAILABLE' | 'BOOKED' | 'BUFFER' | 'CLOSED';
...
export default function TimeSlotCard({
  ...
  return (
    ...
    >
      ...
      <Text style={[styles.status, { color: p.text }]}>
        {status === 'AVAILABLE' ? 'Tersedia' : status === 'BOOKED' ? 'Penuh' : status === 'BUFFER' ? 'Buffer' : 'Tutup'}
      </Text>
    </TouchableOpacity>
  );
}
