...
class UpdateFieldRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            'name'            => 'sometimes|required|string|min:5|max:' . $settings->max_name_length,
            'sport_type'      => ['sometimes', 'required', 'string', 'max:50', Rule::exists('sports', 'slug')->where('is_active', true)],
    ...
    public function messages(): array
    {
        ...
        return [
            ...
            'image_url.required'      => 'Gambar utama lapangan wajib diisi saat diperbarui.',
